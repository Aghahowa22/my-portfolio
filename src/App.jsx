  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <main className="mx-auto max-w-7xl px-6 py-8 lg:px-8 lg:py-10">
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1fr_0.7fr] lg:items-start">
          <div className="space-y-8">
            <div className="rounded-4xl border border-slate-800 bg-slate-900/85 p-6 shadow-xl shadow-slate-950/20">
              ...
              <p className="mt-3 text-base leading-7 text-slate-300">
                Five polished projects that demonstrate my ability to deliver
                refined front-end experiences for product teams, marketing
                initiatives, and user-facing dashboards.
              </p>
            </div>

            <div id="projects" className="grid gap-5 xl:grid-cols-2 sm:grid-cols-2">
